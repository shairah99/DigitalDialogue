...
<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #F0E68C;">
    Activities Digital Dialogue Club
  </nav>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00fffff;">
<h5>| <a href="index.php">Home </a>| <a href="membership.php">Membership</a> | <a href="activity.php">Activities </a> | <a href="contact.php">Contact Us</a> | </h5></p>
</nav>
  <div class="container">
    <?php
    if (isset($_GET["msg"])) {
    ...
    ?>
	<p align="center"><h3>Activities form for Digital Dialogue Club</h3></p>
