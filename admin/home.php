...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="#ddds/index.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Home</a> 
...
<div class="w3-container">
    ...
    <div class="w3-row">
      ...
      <div class="w3-col m10 w3-container">
        ...
        <p>Awarded to the members of Digital dialogue that have a good leadership in society</p><br>
      </div>
    </div>
